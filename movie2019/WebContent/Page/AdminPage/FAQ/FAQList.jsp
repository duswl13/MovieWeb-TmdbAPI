...
<div class="container">
<h1><strong>FAQ 게시글 목록</strong></h1><br><br>
			...
			<tr>
				...
				<td>
					<div>
						...
						<a href="FAQDetailAction.fa?num=${b.FAQ_NUMBER }">
							${b.FAQ_SUBJECT }
						</a>
					</div>
					</td>
