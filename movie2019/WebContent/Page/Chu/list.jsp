...
<body style="background-color: black;">
	...
	<div class="container">
		...
		<div class="container" style="height: 30%">
			<h3 style="color: white;">영자추천</h3>
			<section class="customer-logos slider">
				<c:forEach var="aChu" items="${aChu}" begin="0" end="8" step="1">
					<div class="slide">
						<a
							href="moviedetail.ml?open=false&id=${aChu.id}&title=${aChu.title}">
							<img src="${image}${aChu.poster_path}">
						</a>
					</div>
				</c:forEach>
			</section>
